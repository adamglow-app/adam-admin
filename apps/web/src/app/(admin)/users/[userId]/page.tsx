...
export default function UserDetailPage({ params }: Props) {
	...
	const { data: user, isLoading: userLoading } = useQuery({
		...
		queryFn: () => adminUsersApi.getById(params.userId),
		retry: false,
	});
